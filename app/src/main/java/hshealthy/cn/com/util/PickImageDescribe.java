...
public class PickImageDescribe implements Parcelable {
	...
	public static final Creator<PickImageDescribe>	CREATOR	= new Creator<PickImageDescribe>() {
		public PickImageDescribe createFromParcel(Parcel source) {
			...
			pickDescribe.setCrop(source.readInt() > 0);
	...
	public static Creator<PickImageDescribe> getCreator() {
		return CREATOR;
	}
